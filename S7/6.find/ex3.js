...
const alien = aliens.find((ali) => {return ali.name === 'Cucushumushu'});
const mutation = mutations.find((mutation) => {return mutation.name == 'Porompompero'});
const myAlien = {...alien , mutation}
console.log(myAlien);